...
<%-- 									 ${sessao.isDisponivel(lugar) ? "disponivel" : "ocupado"}" --%>
										<svg class="assento id="${lugar.id}"  version="1.0" id="SEAT" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
